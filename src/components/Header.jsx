...
const Header = () => {
  const { input, handleChange, handleSubmitForm, date, time } =
    useContext(TodoContext);

  return (
    <div className="text-center font-semibold mt-5">
      <h1 className="text-2xl mb-4">Your to do</h1>
      ...
      <ul className="flex justify-around items-center gap-5 my-8 mx-0 border-b-black text-gray-700 font-extrabold">
